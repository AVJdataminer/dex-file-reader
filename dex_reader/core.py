#!/usr/bin/env python3
"""
Core DEX Vending Machine Log Reader

This module contains the main DEXReader class for parsing and analyzing
DEX (Data Exchange) log files from vending machines.
"""
